        ...
        children: [
          Container(
            ...
            child: Image.asset(
              ...
              color: isSelected ? Colors.white : Colors.black, // Change image color based on selection
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10), // Set the corner radius to 10
                ),
              ),
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  ...
                  Icon(Icons.add, color: Colors.white), // Icon color set to white
                ],
              ),
            ),
          ),
